...
#line 113 "bnftoyacc.y"
                    {AddQuadruple("+",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1263 "y.tab.c"
    break;

  case 16: /* EXPR: EXPR '-' EXPR  */
#line 115 "bnftoyacc.y"
                {AddQuadruple("-",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1269 "y.tab.c"
    break;

  case 17: /* EXPR: EXPR '*' EXPR  */
#line 117 "bnftoyacc.y"
                {AddQuadruple("*",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1275 "y.tab.c"
    break;

  case 18: /* EXPR: EXPR '/' EXPR  */
#line 119 "bnftoyacc.y"
                {AddQuadruple("/",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1281 "y.tab.c"
    break;

  case 19: /* EXPR: '-' EXPR  */
#line 121 "bnftoyacc.y"
           {AddQuadruple("UMIN",(yyvsp[0].var),"",(yyval.var));}
#line 1287 "y.tab.c"
    break;

  case 20: /* EXPR: '(' EXPR ')'  */
#line 123 "bnftoyacc.y"
               {strcpy((yyval.var),(yyvsp[-1].var));}
#line 1293 "y.tab.c"
    break;

  case 23: /* CONDST: IFST  */
#line 135 "bnftoyacc.y"
            {
